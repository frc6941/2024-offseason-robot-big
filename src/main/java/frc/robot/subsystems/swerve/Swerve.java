...
//        System.out.println(speeds.toString());
    ...
    public void telemetry() {
        ...
        SmartDashboard.putString("Swerve/Auto Pos/Playoff", AllianceFlipUtil.shouldFlip() ?
                new Pose2d(16.541 - 1.46, 3.11, Rotation2d.fromDegrees(180)).minus(
                        this.getLocalizer().getCoarseFieldPose(0)).toString() :
                this.getLocalizer().getCoarseFieldPose(0).minus(
                        new Pose2d(1.46, 3.11, Rotation2d.fromDegrees(0))).toString());
    ...
    public boolean aimingReady(double offset) {
        ...
        SmartDashboard.putNumber("aimOffsetSwerve", Math.abs(gyro.getYaw().getDegrees() - headingTarget));
