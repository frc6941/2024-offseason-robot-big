...
public class ShooterIOTalonFX implements ShooterIO {
    ...
    private final TalonFX rightShooterTalon = new TalonFX(RIGHT_SHOOTER_MOTOR_ID, Constants.RobotConstants.CAN_BUS_NAME);
    ...
    public final StatusSignal<Double> armPosition = armTalon.getPosition();
    ...
    public ShooterIOTalonFX() {
        var armMotorConfig = new TalonFXConfiguration()
                ...
                .withMotionMagic(armmotionMagicConfigs)
